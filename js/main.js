...
const synth = window.speechSynthesis || window.wekitspeechSynthesis;
...
function speak() {
  ...
  utterance.pitch = parseInt(pitch.value);
  utterance.rate = parseInt(rate.value);
  utterance.onstart = () => {
    isSpeaking = true;
